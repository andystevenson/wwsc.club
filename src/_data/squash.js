module.exports = {
  ...
  alumni: [
    ...
    { name: 'Jasmine Hutton', bio: '', image: 'jasmine-hutton', current: true },
    { name: 'Jonah Bryant', bio: '', image: 'jonah-bryant-2', current: true },
    {
      name: 'Sam Osborne-Wylde',
      bio: '',
    ...
    { name: 'Hassan Khalil', bio: '', image: 'hassan-khalil', current: true },
    { name: 'Ali Khalil', bio: '', image: 'ali-khalil', current: true },
    { name: 'Charlie Lee', bio: '', image: 'charlie-lee', current: true },
    {
